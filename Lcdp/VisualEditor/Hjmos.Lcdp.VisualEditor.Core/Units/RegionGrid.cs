...
namespace Hjmos.Lcdp.VisualEditor.Core.Units
{
    ...
    /// 分区域Grid组件
    /// </summary>
    [Widget(Category = "布局组件", DisplayName = "网格", DefaultWidth = 300d, DefaultHeight = 300d)]
    ...
    public class RegionGrid : Grid, IRegion
    {
        ...
        public IUnitNode GetNode()
        {
            ...
            foreach (UIElement child in Children)
            {
                ...
                {
                    IUnitNode childNode = unit.GetNode();
        ...
        public void InitParameterBinding() => throw new NotImplementedException();
    }
}
