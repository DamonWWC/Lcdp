...
namespace Hjmos.Lcdp.VisualEditor.Controls
{
    public class PropertyItem : ListBoxItem
    {
        ...
        public static readonly DependencyProperty SourcePropertyProperty = DependencyProperty.Register(
    "SourceProperty", typeof(DependencyProperty), typeof(PropertyItem), new PropertyMetadata(default(DependencyProperty)));

        public DependencyProperty SourceProperty
        {
            get => (DependencyProperty)GetValue(SourcePropertyProperty);
